angular.
	...
	$scope.url = "https://www.google.com/calendar/feeds/5150kd3jr504516f79cnsn78i8%40group.calendar.google.com/private-39fbe9bdca4964c99099bb1463b50508/basic?alt=json&max-results=25";
    ...
    controller('EventCtrl',
		...
		function($scope,$routeParams,$http,$sce,$rootScope){
		    $scope.id = $routeParams['id'];
		    var id = $scope.id;
		    $scope.url = "https://www.google.com/calendar/feeds/5150kd3jr504516f79cnsn78i8%40group.calendar.google.com/private-39fbe9bdca4964c99099bb1463b50508/basic/"+id+"?alt=json";
		    $http.get($scope.url).success(function(data){
    ...
    controller('indexCtrl',
		   ...
		   $scope.url = "https://www.google.com/calendar/feeds/5150kd3jr504516f79cnsn78i8%40group.calendar.google.com/private-39fbe9bdca4964c99099bb1463b50508/basic?alt=json&max-results=4";
		   $scope.getID = function(url){
		       var id = url.split("/").pop();
		       return id;
		   };
    ...
    .controller("CalendarCtrl",
		['$scope','$routeParams','$modal','ModalService','regionService',
		 function($scope,$routeParams,$modal,modalService,region){
		     ...
		     $scope.eventSource = {
			 url:"https://www.google.com/calendar/feeds/5150kd3jr504516f79cnsn78i8%40group.calendar.google.com/private-39fbe9bdca4964c99099bb1463b50508/basic",
